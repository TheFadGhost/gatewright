...
// documented contract (DESIGN.md §6): it is enforced by the route-chain
// assembly in internal/runtime/assemble.go (routeChain) and surfaced by trace
// mode. Changing the order is a breaking change to Gatewright's observable
// behaviour.
package middleware
